function cartAdder() {
    add_btn = document.getElementById('button_add_to_cart');
    add_btn.addEventListener("click", () => {
        ...
        product_details_json = JSON.stringify(product_details_obj)
        if (sessionStorage.hasOwnProperty('cart_items')) {
            current_array = [sessionStorage.getItem('cart_items')];
